...
// }
?>
<?php  function buildTitle(
  $title = 'Atlas.travel ',
  $keywords = 'Cheap Flights, Booking Engine, Hotels, Car Rental, Vacation Packages, Flight Tickets, Cheap Tickets, Travel Agency',
  $og_title ='Cheap flight tickets, tickets to Iran, All-inclusive vacations',
  $og_desc = 'Atlas Travel',
  $og_img ='fb_common.jpg',
  $og_url='https://www.atlas.travel'
){ ?>
<!doctype html>
<html>
    <head>
    <title><?php if (isset($title) ){ echo $title. " | Atlas Travel";}?>    </title>
    <meta name="Robots" content="index, follow">
    <meta name="google-site-verification" content="G2O8-RU7ndZ8HPXWSzSol3ULxcgIlFxZ4J9HnLqC72I" />
    <meta charset="utf-8">
    <meta name="description" content="The Travel Booking Expert">
    <meta name="keywords" content="<?php if (isset($keywords) ){ echo $keywords. " | Atlas Travel";} ?>">
  ...
  <!-- Social tags -->
    ...
    <meta property="og:description" content="<?php if (isset($og_desc) ){ echo $og_desc;} ?>">
    <meta property="og:image" content="https://www.atlas.travel/images/<?php if (isset($og_img) ){ echo $og_img;} ?>">
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato|Saira+Semi+Condensed|Yanone+Kaffeesatz" rel="stylesheet">
    ...
    <!-- <link href="css/cuppa/cuppa-datepicker-styles.css" rel="stylesheet"> -->
...
<?php  function buildMenu($target = 'active', $menu_type  = 'default'){?>

<section class="top-header new-top-nav">
  <div class="container">
    <div class="row">
      <div class="col-sm-4">
        <a class="logo ga_event" data-category="Menu" data-action="Click" data-label="Home Logo Link" href="/"><img src="/images/logo_blue.png" alt="Atlas Travel"></a>
      </div>
      <div class="col-sm-8">
        <ul class="top-menu-list top-menu-list-right">
          <!-- <li><a class="ga_event" data-category="Full_Nav" data-action="Click" data-label="Agent email Link" href="mailto:agent@atlas.travel"><i class="fa fa-envelope"></i>agent@atlas.travel</a></li> -->
          <li>
            <a class="ga_event top_tel_num" data-category="Full_Nav" data-action="Click" data-label="877 Number Link" href="tel:18776005454" ><i class="fa fa-globe"></i>1.877.600.5454</a>
            <span class="top_contact_info">Mon - Fri : 8:00 am to 8:00 pm | Sat: 10:00 am to 5:00 pm </span>
            <span class="top_contact_info"></span>
            <a class="<?php if ($target == 'contact'){echo 'top_menu active';} ?> ga_event" data-category="Full_Nav" data-action="Click" data-label="Contact Link" href="contact.php"><i class="fa fa-envelope"></i>Contact Us</a>
          </li>
        </ul>
...
<section class="section-top-header" style="display:none">
            ...
            <div class="row">
              <div class="col-md-12">
                    ...
                    <div class="top-contact">
                       ...
                       <a class="btn btn-social-icon btn-facebook top-hide ga_event" data-category="Full_Nav" data-action="Click" data-label="Facebook Link" href="https://www.facebook.com/atlastravel1" target="_blank">
                            <span class="fa fa-facebook"></span>
                      </a>
                      <a class="btn btn-social-icon btn-twitter top-hide ga_event" href="https://twitter.com/AtlasTravel_" target="_blank" data-category="Full_Nav" data-action="Click" data-label="Twitter Link">
                        <span class="fa fa-twitter"></span>
                      </a>
                      <span class="top-hide"><a class="ga_event" data-category="Full_Nav" data-action="Click" data-label="416 Number Link" href="tel:4162220717"><i class="fa fa-phone"></i>(416) 222.0717</a></span>
                      <span><a class="ga_event" data-category="Full_Nav" data-action="Click" data-label="877 Number Link" href="tel:18776005454" ><i class="fa fa-globe"></i>1.877.600.5454</a></span>
                    </div>
                    <div class="top-login">
                        <div class="header-lang">
                          <a class="<?php if ($target == 'contact'){echo 'top_menu active';} ?> ga_event" data-category="Full_Nav" data-action="Click" data-label="Contact Link" href="contact.php"><i class="fa fa-envelope"></i>Contact</a>
                        </div>


                      <span><a class="ga_event" data-category="Full_Nav" data-action="Click" data-label="Agent email Link" href="mailto:agent@atlas.travel"><i class="fa fa-envelope"></i>agent@atlas.travel</a></span>
                    </div>
              </div>
            </div>
        </div>
    ...
    <section class="top-menu-link secondary-nav">
      <div class="top-mega-menu__">
        <div class="container">
          <ul class="travel-mega-menu travel-mega-menu-response-to-icons">
                <!-- <li class="line-logo"><a class="logo ga_event" href="/" data-category="Full_Nav" data-action="Click" data-label="Home Logo Link"><img src="/images/logo_orig.png" alt="Atlas Travel"></a></li> -->
                <li>
                    <a class="top-menu-txt ga_event <?php if ($target == 'flights'){echo 'active';} ?>" href="/flights.php" data-category="Full_Nav" data-action="Click" data-label="Flights Link"><i class="fa fa-plane"></i>Flights</a>
                </li>
                <li>
                    <a class="top-menu-txt ga_event  <?php if ($target == 'hotels'){echo 'active';} ?>" href="/hotels.php" data-category="Full_Nav" data-action="Click" data-label="Hotels Link"><i class="fa fa-hotel"></i> Hotels</a>
                </li>
                <li>
                    <a class="top-menu-txt ga_event <?php if ($target == 'cars'){echo 'active';} ?>" href="/cars.php"  data-category="Full_Nav" data-action="Click" data-label="Cars Link"><i class="fa fa-car"></i>Cars</a>
                </li>
                <li class="">
                    <a class="top-menu-txt ga_event <?php if ($target == 'vacations'){echo 'active';} ?>" href="/vacations.php"  data-category="Full_Nav" data-action="Click" data-label="Vacations Link"><i class="fa fa-sun-o"></i>Vacations</a>
                </li>
                <li class="center">
                    <a class="top-menu-txt ga_event <?php if ($target == 'insurance'){echo 'active';} ?>" href="/insurance.php" data-category="Full_Nav" data-action="Click" data-label="Insurance Link"><i class="fa fa-briefcase"></i>Insurance</a>
                </li>
                <li>
                    <a class="top-menu-txt ga_event <?php if ($target == 'travel_tools'){echo 'active';} ?>" href="/travel_tools.php" data-category="Full_Nav" data-action="Click" data-label="Travel Tools Link"><i class="fa fa-wrench"></i>Travel Tools</a>
                    <div class="grid-container3 blue-link">
                        <ul>
                            <li><a href="/faq.php" class="ga_event" data-category="Full_Nav" data-action="Click" data-label="FAQ Link"><i class="fa"></i>FAQ</a></li>

                                          <li><a class="ga_event" href="/assets/contents/credit-card-form.pdf" target="_blank" data-category="Full_Nav" data-action="Click" data-label="Credit Card FOrm Link"><i class="fa pdf"></i>Credit Card Form</a></li>
                                          <li><a href="/bonus.php" class="ga_event" data-category="Full_Nav" data-action="Click" data-label="Bonus Link"><i class="fa"></i>Bonus</a></li>
                                </ul>
                    </div>
                </li>
          ...
          <nav id="mobile-menu-01" class="mobile-menu">
                <div class="line-logo">
              <a class="logo ga_event" data-category="Mobile_Menu" data-action="Click" data-label="Home Logo Link" href="/"><img src="/images/logo_orig.png" alt="Atlas Travel"></a><i class="fa fa-bars"></i>
            </div>
                <div class="clear"></div>
                <ul class="travel-mega-menu-mobile">
                  <li class="line-mini-menu k-opn">
                    <a class="top-menu-txt ga_event" href="/index.php" data-category="Mobile_Menu" data-action="Click" data-label="Home Link">Home</a>
                  </li>
                  <li class="line-mini-menu k-opn">
                    <a class="top-menu-txt ga_event" href="/flights.php" data-category="Mobile_Menu" data-action="Click" data-label="Flights Link">Flights</a>
                  </li>
                  <li class="k-opn">
                    <a class="top-menu-txt ga_event" href="/hotels.php" data-category="Mobile_Menu" data-action="Click" data-label="Hotels Link">Hotels</a>
                  </li>

                  <li class="k-opn">
                    <a class="top-menu-txt ga_event" href="/cars.php" data-category="Mobile_Menu" data-action="Click" data-label="Cars Link">Cars</a>
                  </li>
        <li class="k-opn">
          <a class="top-menu-txt ga_event" href="/vacations.php" data-category="Mobile_Menu" data-action="Click" data-label="Vacations Link">Vacations</a>
        </li>
        <li class="k-opn">
          <a class="top-menu-txt ga_event" href="/insurance.php" data-category="Mobile_Menu" data-action="Click" data-label="Insurance Link">Insurance</a>
        </li>
          <li class="line-mini-menu k-opn">
                    <a class="top-menu-txt ga_event" href="#" data-category="Mobile_Menu" data-action="Click" data-label="Travel Tools Link">Travel Tools</a>
                        ...
                        <form>
                            <fieldset>
                                <div class="row">
                                    <section class="col">
                                            <ul>
                                              <li><a href="/faq.php" class="ga_event"  data-category="Mobile_Menu" data-action="Click" data-label="FAQ Link">FAQ</a></li>
                                              <li><a href="/assets/contents/credit-card-form.pdf" class="ga_event"  data-category="Mobile_Menu" data-action="Download" data-label="Credit Card Link">Credit Card Form</a></li>
                                              <li><a href="/bonus.php" class="ga_event"  data-category="Mobile_Menu" data-action="Click" data-label="Bonus Link">Bonus</a></li>
                                            </ul>
                                    </section>
                                </div>
                            </fieldset>
...
<?php  function buildFooter($jsFile = 'booking', $jsFileSecond = '' ){ ?>

<!-- Footer -->
<section id="footer">
    <div class="container">
      <div class="row">
          <div class="col-sm-12 news_letter_box">
           ...
           <div class="row footer_menu">
             <div class="col-md-12">
               <a href="/flights.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="Flights Link">Flights</a>
               <a href="/hotels.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="Hotels Link">Hotels</a>
               <a href="/cars.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="Cars Link">Cars</a>
               <a href="/vacations.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="Vacations Link">Vacations</a>
               <a href="/insurance.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="Insurance Link">Insurance</a>
               <a href="/contact.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="Contact Link">Contact</a>
               <a href="/travel_tools.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="Travel Tools Link">Travel Tools</a>
               <a href="/faq.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="FAQ Link">FAQ</a>
               <a href="/assets/contents/credit-card-form.pdf" class="ga_event"  data-category="Footer_Menu" data-action="Download" data-label="Creadit Card Form Link">Credit Card Form</a>
               <a href="/bonus.php" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="Bonus Link">Bonus</a>
               <a href="/sitemap.xml" class="ga_event"  data-category="Footer_Menu" data-action="Click" data-label="SiteMap Link">Site MAp</a>
                <p><img class='logo-footer' src='/images/logo_orig.png' alt='Atlas Travel | Cheap Flights ' /></p>
                <p>6075 Yonge St., 2nd Floor, Toronto , Ontario, M2M 3W2 Canada</p>
                <p>
                  <a href="tel:416-222-0717">Phone :  (1) 416-222-0717</a>
                  <a href="tel:1-877-600-5454">Toll Free : 1-877-600-5454</a>
                  <a href="#">Fax: 416-222-9084</a>
                  <a href="mailto:agent@atlas.travel">agent@atlas.travel</a>
                </p>
    ...
    <div class="footer-bottom">
        <div class="container">
          <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                    <div class="col-xs-6 copyright">Atlas Travel © 2017 All Rights Reserved &nbsp; <br />
...
<script src="/js/<?php echo "$jsFileSecond"?>.js" type="text/javascript"></script>
<?php  } ?>

<?php // Page specific Js file
//if ( isset($jsFile) && $jsFile != ''){  ?>
<script src="/js/<?php //echo "$jsFile"?>booking.js" type="text/javascript"></script>
<?php // } ?>


<!-- <script src="/date_picker/lib/picker.js"></script>
<script src="/date_picker/lib/picker.date.js"></script>
<script src="/date_picker/lib/legacy.js"></script> -->
...
<?php }   ?>
  ...
  <?php function __buildSearchForm($flight_origin ="",
$flight_destination = ""){?>
...
<form id="flights-tab" class="tab-pane form-inline reservation-hotel flights_form  <?php if (isset($search_box )){ if ($search_box == 'flights' || $search_box == 'home') { ?>active<?php } }?>" name="frmAirSearch" method="get" action="https://res.atlas.travel/process.aspx" enctype="multipart/form-data" onSubmit="return true;"  autocomplete="off">
...
<div class="row">
    <div class="col-sm-4">
      <div class="form-group">
                ...
                <div class="content-checkin-data">
                    ...
                    <input  type="text" name="txtDepCity1" class="txtDepCity cls_autofill form-control" value="<?php if (isset($flight_origin)) {echo $flight_origin;}?>"  placeholder="Departure"  onChange="copyTextbox(this, document.getElementById('txtArrCity2'));" autocomplete="off" id="txtDepCity1">
                </div>
      </div>
    </div>
    ...
    <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="content-checkin-data">
                  <i class="fa fa-plane infield"></i>
                  <input  type="text" name="txtArrCity1" class="txtDepCity cls_autofill form-control" value="<?php if (isset($flight_destination)) {echo $flight_destination;}?>" defValue="Arrival"  placeholder="Arrival"  onChange="copyTextbox(this, document.getElementById('txtDepCity2'));" autocomplete="off" id="txtArrCity1">
              </div>
            </div>
    </div>
