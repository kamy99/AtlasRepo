...
<section id="srch_frm_flght_single">
<div class="row">
  <div class="col-sm-6">
...
</section> <!-- eof  srch_frm_flght_single-->
<!-- 
<section id="srch_frm_flght_multi">
...
<?php for ( $i= 2; $i < 7; $i++ ) { ?>
                                           ...
                                           <div class="col-sm-4 cc-in no_left_padding">
                                              <div class="form-group">
                                                <div class="content-checkin-data">
                                                  <i class="fa fa-plane infield"></i>
                                                    <input name="txtDepCity<?php echo $i;?>" type="text" id="txtDepCity<?php echo $i;?>" value="" class="form-control airport_search  cls_autofill" placeholder="Departure"/>
                                                </div>
                                              </div>
                                            </div>
                                            <div class="col-sm-4 cc-out no_left_padding">
                                              <div class="form-group">
                                                <div class="content-checkin-data">
                                                  <i class="fa fa-plane infield"></i>
                                                    <input name="txtArrCity<?php echo $i;?>" type="text" id="txtArrCity<?php echo $i;?>" value="" class="form-control  cls_autofill" placeholder="Arrival"/>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 cc-out">
                                              <div class="form-group">
                                                <div class="content-checkin-data">
                                                    <i class="fa fa-calendar infield"></i>
                                                    <input name="txtdate<?php echo $i;?>" type="text" id="txtdate<?php echo $i;?>" value="" class="form-control DepartureDate<?php echo $i;?>" placeholder="Date"/>
                                                </div>
                                              </div>
                                            </div>
<?php } ?>
