...
<div id="srch_frm_flght_oneway" class="row">
  <div class="col-sm-4">
      <div class="form-group">
                <label for="checkin">From:</label>
                <div class="popover-icon" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" data-content=""> <i class="fa fa-info-circle fa-lg"> </i> </div>
                <div class="content-checkin-data">
                    <i class="fa fa-plane infield"></i>
                    <input  type="text" name="txtDepCity2" class="txtDepCity cls_autofill form-control" value=""  placeholder="Departure"  autocomplete="off" id="txtDepCity2">
                </div>
              </div>
  </div>
  ...
  <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="content-checkin-data">
                  <i class="fa fa-plane infield"></i>
                  <input  type="text" name="txtArrCity2" class="txtDepCity cls_autofill form-control" value="" defValue="Arrival"  placeholder="Arrival"   autocomplete="off" id="txtArrCity2">
              </div>
            </div>
  </div>
...
<div id="srch_frm_flght_multi" class="row">
  <div class="col-sm-4">
      <div class="form-group">
                <label for="checkin">From:</label>
                <div class="popover-icon" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" data-content=""> <i class="fa fa-info-circle fa-lg"> </i> </div>
                <div class="content-checkin-data">
                    <i class="fa fa-plane infield"></i>
                    <input  type="text" name="txtDepCity3" class="txtDepCity cls_autofill form-control" value=""  placeholder="Departure"  autocomplete="off" id="txtDepCity3">
                </div>
              </div>
  </div>
  ...
  <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="content-checkin-data">
                  <i class="fa fa-plane infield"></i>
                  <input  type="text" name="txtArrCity3" class="txtDepCity cls_autofill form-control" value="" defValue="Arrival"  placeholder="Arrival"   autocomplete="off" id="txtArrCity3">
              </div>
            </div>
  </div>
  ...
  <div class="col-sm-4">
              <div class="form-group return_panel">
                ...
                <div class="content-checkin-data">
                    <i class="fa fa-calendar infield"></i>
                    <input name="txtDate3" type="text" id="checkout3" value="" class="form-control checkout" placeholder="Return Date"/>
                </div>
              </div>
  </div>
</div>
