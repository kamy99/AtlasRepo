...
<!-- <link href="/css/date_picker/default.date.css" rel="stylesheet">
<link href="/css/date_picker/default.time.css" rel="stylesheet">
<link href="/css/date_picker/pickadate_default.css" rel="stylesheet">  -->
...
<form id="flights-tab" class="tab-pane form-inline reservation-hotel flights_form  <?php if ($search_box == 'flights' || $search_box == 'home' || $search_box == 'cathay') { ?>active<?php } ?>" name="frmAirSearch" method="get" action="https://res.atlas.travel/process.aspx" enctype="multipart/form-data" onSubmit="return true;"  autocomplete="off">
