...
<!-- eof new block -->
<form id="flights-tab" class="tab-pane form-inline reservation-hotel flights_form  <?php if ($search_box == 'flights' || $search_box == 'home') { ?>active<?php } ?>" name="frmAirSearch" method="get" action="https://res.perfectibe.com/process.aspx" enctype="multipart/form-data" onSubmit="return true;"  autocomplete="off">
  <input type="hidden" id="AgentID" name="AgentID" value="258"/>
  <input type="text" name="txtDepCity2" id="txtDepCity2">
  <input type="text" name="txtArrCity2" id="txtArrCity2">
...
<div class="row">
  ...
  <button type="text" id="booking_search_btn" class="btn btn-primary btn-block search_btn center-block">Search! </i> </button>
  </div>
</div>
