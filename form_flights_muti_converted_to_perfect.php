...
<form id="flights-tab" class="tab-pane form-inline reservation-hotel flights_form  <?php if ($search_box == 'flights' || $search_box == 'home') { ?>active<?php } ?>" name="frmAirSearch" method="get" action="https://res.atlas.travel/process.aspx" enctype="multipart/form-data" onSubmit="return true;"  autocomplete="off">
 ...
 <!--  <input type="hidden" name="txtDepCity2" class="txtDepCity cls_autofill" value="Airport or City" defValue="Airport or City"  id="txtDepCity2" />
  ...
  <!-- <input  type="hidden" name="txtArrCity2" class="txtDepCity cls_autofill form-control" value="" defValue="Arrival"  placeholder="Arrival"   autocomplete="off" id="txtArrCity2">
  <input  type="hidden" name="txtDepCity2" class="txtDepCity cls_autofill form-control" value=""  placeholder="Departure"  autocomplete="off" id="txtDepCity2">
 -->

  <div id="flight_form_slector" class="row">
      <h3 class="srch_box_slogan">Cheap Flight Deals ! </h3>
  <div class="col-sm-8">
...
<div class="row">
    <div class="col-sm-4">
      <div class="form-group">
                <label for="checkin" class="hide_me">From:</label>
    ...
    <div class="col-sm-4">
            <div class="form-group">
              <label for="checkout"  class="hide_me">To:</label>
              <div class="content-checkin-data">
                  <i class="fa fa-plane infield"></i>
    ...
    <div class="col-sm-2 srch_box_date">
              <div class="form-group">
                <label for="checkin"  class="hide_me">Depart Date</label>
                <div class="content-checkin-data">
                    <i class="fa fa-calendar infield"></i>
                    <input name="txtDate1" type="text" id="checkin" value="" class="form-control checkin" placeholder="Dep. Date"/>
                </div>
              </div>
    </div>

    <div class="col-sm-2 rtn_date_1 srch_box_date">
               <div class="form-group return_panel">
                <label for="checkout"  class="hide_me">Return Date</label>
                <div class="content-checkin-data">
                    <i class="fa fa-calendar infield"></i>
...
<div class="col-sm-6 psngrs-box">
                                            <div class="col-sm-4BKUP psngrs" >
                                               <div class="form-group">
...
<div class="row flight_options_row">
  ...
  <div class="col-sm-12">
                                <div class="no_left_padding cabin_box">
                                  <div class="form-group">
                                        ...
                                        <select class="form-control" name="ddlCabin" id="ddlCabin">
                                           ...
                                           <div class="no_left_padding no_right_padding airline_box">
                                              <div class="form-group">
