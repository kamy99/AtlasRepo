...
<script type="text/javascript">var enable_dropdown=true;</script>

<form id="flights-tab" class="tab-pane form-inline reservation-hotel flights_form  <?php  if ( isset($search_box) && (  $search_box == 'flights' || $search_box == 'home' || $search_box == 'cathay') ) { ?>active<?php } else {echo "nope";} ?>" name="frmAirSearch" method="get" action="https://res.atlas.travel/process.aspx" enctype="multipart/form-data" onSubmit="return true;"  autocomplete="off">
  <input type="hidden" id="AgentID" name="AgentID" value="258"/>
  <input type="hidden" name="txtCoupon" value="">

<!-- <div style="border:1px red solid; overflow:hidden"> -->

  <!-- <div id="cuppaDatePickerContainer"></div> -->

  <!-- <link rel="stylesheet" href="/date_picker/lib/themes/default.css">
  <link rel="stylesheet" href="/date_picker/lib/themes/default.date.css">

  <h3>Date picker test area</h3>
...
<!-- row start -->
<div id="srch_frm_flght_single" class="row">
    <div class="col-sm-6">
