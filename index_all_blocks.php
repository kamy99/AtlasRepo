        ...
        <div class="container">
            <div class="row">
              <div class="col-md-12">
                    ...
                    <div class='top-login'>
                      <i class="fa fa-phone"></i><span>+12 123 456 789</span><i class="fa fa-envelope"></i><span>info@travego.com</span>

<span class="header_socail">  <a href="https://www.facebook.com/atlastravel1" target="_blank" class="icon-button facebook"><i class="icon-facebook"></i><span></span></a> </span>
<span class="header_socail">  <a href="https://twitter.com/AtlasTravel_"  target="_blank" class="icon-button twitter"><i class="icon-twitter"></i><span></span></a></span>
	...
	<section>
      ...
      <!-- mega menu -->
			<ul class="travel-mega-menu travel-mega-menu-response-to-icons">		
                <li class="line-logo">
					<a class="logo" href="#"><img src="images/logo-blue.png" alt=""/></a>
				</li>		
                                    ...
                                    <section class="col col-md-4">
                                        <h3>Special</h3>
                                            <ul>
                                              ...
                                              <li><a href="meteo.html">Travego Weather</a></li>
                                            </ul>
									</section>
								</div>
							</fieldset>						
                                   ...
                                   <div class="reservation-tabs">
                                        ...
                                        <div class="row">
                                           <ul class="nav nav-tabs search-opt">
                                                    <li class="hide_this_tab"><a href="#hotels-tab" data-toggle="tab">HOTELS</a></li>
                                                    <li class="active active_tab"><a href="#flights-tab" data-toggle="tab">FLIGHTS</a></li>
                                                    <li class="hide_this_tab"><a href="#flights-tab" data-toggle="tab">FLIGHT &amp; HOTELS</a></li>
                                                </ul>
                                        </div>
                                    </div>
...
&To=AMS&
QTo=A&
DepartureDate=19%2F04%2F2016
&DepartureTime=09%3A00
&ReturnDate=26%2F04%2F2016
&ReturnTime=09%3A00
&AdtCount=1&
ChdCount=2&
InfCount=3&
IsCalendarSearch=false&IsMajorCabin=false&Culture=en-US&
Method=Search

 -->


                                    <form id="hotels-tab" class="tab-pane form-inline reservation-hotel active" method="get" action="https://staging.epower.amadeus.com/showroom3/" name="reservationform">
                                      <div class="row">
                                        <div class="col-sm-2 step-where">

               <input name="TripType" value="rdbRoundTrip" id="rdbRoundTrip" checked="checked" type="radio">
                <label for="rdbRoundTrip" class="radio-inline">Round-Trip</label>
                <input name="TripType" value="rdbOneWay" id="rdbOneWay" type="radio">
                <label for="rdbOneWay" class="radio-inline">One-Way</label>
                 <input name="TripType" value="rdbMultiCity" id="rdbMultiCity" type="radio">
                 <label for="rdbMultiCity" class="radio-inline">Multi-City</label>  

                                          <!-- <div class="form-group ">
                                            <h3><span>01</span> Depart:</h3>
                                        ...
                                        <div class="col-sm-4 step-check">
                                            <div class="col-sm-6 cc-in" style="padding-left:0">
                                              <div class="form-group">
                                                ...
                                                <div class="content-checkin-data">
                                                    ...
                                                    <input name="from" type="text" id="from" value="" class="form-control" placeholder="Departure"/>
                                                </div>
                                              </div>
                                            </div>
                                            <div class="col-sm-6 cc-out" style="padding-left:0">
                                              <div class="form-group">
                                                ...
                                                <div class="content-checkin-data">
                                                    <i class="fa fa-calendar infield"></i>
                                                    <input name="checkout" type="text" id="to" value="" class="form-control" placeholder="Arrival"/>
                                                </div>
                                              </div>
                                            </div>
                                        </div>
                      ...
                      <div class="col-md-6 meteo-top-travel meteo-slider-top">
                            <div id="home_promos"><img src="images/promos/lowest_prices.jpg"></div>
                        </div>
              </div>
            </div>
           </div>
    ...
    <div class="container">
      <div class="row">
         <div class="col-md-12 effect-5 effects no-border-img">
            ...
            <div class="col-md-6 content-man mandesc"><img alt="" src="images/man.jpg" alt=""/></div>
        </div>
      </div>
    </div>
</section>
             ...
             <div class="bx-about2">
                <ul class="bxslider all-info-trip">
                            <li>
                             ...
                             <div class="trip-slide-price noshadow col-md-5">
                                <div class="trip-slide-text prague">Paris 
                                <div class="line-price clear"></div>
                                <span> € 399</span>
                                <div class="line-price clear"></div>
                             ...
                             <div class="trip-slide-price noshadow col-md-5">
                                <div class="trip-slide-text prague">Venice 
                                <div class="line-price clear"></div>
                                <span> € 490</span>
                                <div class="line-price clear"></div>
                                <a href="#" class="btn btn-primary btn-gallery">Buy Now</a></div>
                             ...
                             <div class="trip-slide-price noshadow col-md-5">
                                <div class="trip-slide-text prague">London 
                                <div class="line-price clear"></div>
                                <span> € 270</span>
                                <div class="line-price clear"></div>
                                <a href="#" class="btn btn-primary btn-gallery">Buy Now</a></div>
                             ...
                             <div class="trip-slide-price noshadow col-md-5">
                                <div class="trip-slide-text prague">Prague 
                                <div class="line-price clear"></div>
                                <span> € 599</span>
                                <div class="line-price clear"></div>
                                <a href="#" class="btn btn-primary btn-gallery">Buy Now</a></div>
...
<!-- SECTION INFORMATION HELP-->
 ...
 <section class="section-help-info ctr-content">
        <div class="container">
           <div class="row">
             <div class="col-md-12">
                <div class="text-center">
                 ...
                 <div class="col-md-6 help-info">
                    <div class="col-md-3"><img src="images/info-help1.png" alt="" /></div>
                    <div class="col-md-9 box-info-help"><h3>BOOKING OF TICKETS</h3><p>Perspiciatis unde omnis iste natus doxes sit voluptatem accusantium doloremque la dantiumeaque ipsa.</p>
                        <a class="help-bt" href="">Read More</a>
                    </div>
                </div>
                 <div class="col-md-6 help-info">
                    <div class="col-md-3"><img src="images/info-help4.png" alt="" /></div>
                    <div class="col-md-9 box-info-help"><h3>TRAVELING WITH FAMILY</h3><p>Perspiciatis unde omnis iste natus doxes sit voluptatem accusantium doloremque la dantiumeaque ipsa.</p>
                        <a class="help-bt" href="">Read More</a>
                    </div>
                </div>
             </div>
           ...
           <div class="row sc-row">
             <div class="col-md-12">
                <div class="col-md-6 help-info">
                    <div class="col-md-3"><img src="images/info-help3.png" alt="" /></div>
                    <div class="col-md-9 box-info-help"><h3>HOW TO CHOOSE A TOUR</h3><p>Perspiciatis unde omnis iste natus doxes sit voluptatem accusantium doloremque la dantiumeaque ipsa.</p>
                        <a class="help-bt" href="">Read More</a>
                    </div>
                </div>
                <div class="col-md-6 help-info">
                    <div class="col-md-3"><img src="images/info-help2.png" alt="" /></div>
                    <div class="col-md-9 box-info-help"><h3>DONT LOST YOUR FLY</h3><p>Perspiciatis unde omnis iste natus doxes sit voluptatem accusantium doloremque la dantiumeaque ipsa.</p>
                        <a class="help-bt" href="">Read More</a>
                    </div>
                </div>
             </div>
                  ...
                  <div class="col-md-3">
                    <h3>TRAVEL NEWS</h3>       
				        <div class="col-md-4 footer-small-img">
                            <img alt="" src="images/footer_news1.jpg"/>
                        </div>
                       ...
                       <div class="clear"></div>
                        <div class="col-md-4 footer-small-img">
                            <img alt="" src="images/footer_news2.jpg"/>
                        </div>
                        <div class="col-md-8 footer-small-desc">
                            <a href="">Amazing Places</a>
                            <p>Mar 26, 2015</p>
