...
buildTitle('');buildMenu('tours');
 ...
 <!-- 
 <div class="banner">        
  <img src="/thebootstrapthemes-hotel/images/photos/banner.jpg" class="img-responsive" alt="slide"> 
...
-->
 ...
 <div class="container">
    ...
    <div class="row search_row border_5px" style="border:3px #257695 solid; background-color:#fff">
    <h1>Search Cheap Flights</h1>
        <div class="col-sm-4" style="background-color: #ff">
