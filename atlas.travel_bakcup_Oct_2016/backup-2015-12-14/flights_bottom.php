...
<div class="col-sm-3 specials_box">

<ul class="specialz effect col-sm-5 border_5px">
    <li>
...
<ul class="specialz effect col-sm-5 border_5px">
    <li>
        <a href="/usa.php">
       <h2 class="zero">USA Flights</h2>
       <p class="zero">Search discounted flights from/to USA</p>
   </a>
    </li>
    <li><a href="/usa.php"><img class="top img-responsive" src="assets/contents/sp-offer-5.png" alt=""/></a></li>
</ul></div>
...
<ul class="specialz effect col-sm-5 border_5px">
    <li>
        <a href="/uk.php">
       <h2 class="zero">UK Flights</h2>
       <p class="zero">Search discounted flights from/to UK</p>
   </a>
    </li>
    <li><a href="/uk.php"><img class="top img-responsive" src="assets/contents/sp-offer-6.png" alt=""/></a></li>
</ul></div>
...
<ul class="specialz effect col-sm-5 border_5px">
    <li>
        <a href="/cars.php">
       <h2 class="zero">Hot Car Deals</h2>
       <p class="zero">Book your Car now and save up to %40 off</p>
   </a>
    </li>
    <li><a href="/cars.php"><img class="top img-responsive" src="assets/contents/sp-offer-7.png" alt=""/></a></li>
</ul></div>
...
<ul class="specialz effect col-sm-5 border_5px">
    <li>
        <a href="/.php">
       <h2 class="zero">Canada Flights</h2>
       <p class="zero">Search discounted flights from/to Canada</p>
   </a>
    </li>
    <li><a href="/index.php"><img class="top img-responsive" src="assets/contents/sp-offer-8.png" alt=""/></a></li>
</ul></div>
