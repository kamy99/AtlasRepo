...
buildTitle('Tours');buildMenu('tours');
 ?>
 <div class="container">
    <div class="row search_row border_5px white_box">
    <h1>Search USA Flights</h1>
        ...
        <div class="col-sm-9"> 
                    ...
                    <div class="col-sm-12">
                       <ul class="bxslider">
                            <li><img src="assets/images/slider/usa/01.jpg"></li>
                            <li><img src="assets/images/slider/usa/02.jpg"></li>
                            <li><img src="assets/images/slider/usa/03.jpg"></li>
                            <li><img src="assets/images/slider/usa/04.jpg"></li>
                       </ul> 
                    </div>
