    <script type="text/javascript" src="https://book.perfectibe.com/scripts/calendar.js"></script>
    <script type="text/javascript" src="https://book.perfectibe.com/scripts/jsDate.js"></script>
    <script type="text/javascript" src="https://book.perfectibe.com/scripts/pibe.js"></script>
    <script type="text/javascript" src="https://book.perfectibe.com/scripts/dropdown.js"></script>
    ...
    <div class="row">
        <?php // start left col?>
            <div class="col-sm-6">
                ...
                <input type="checkbox" name="chkFlexSearch1" id="chkFlexSearch1" value="true" class="checkbox-inline" checked="checked"/>
                <label for="chkFlexSearch1">Flexible dates</label>
    ...
    <div class="row">
        <?php // start left col?>
            <div class="col-sm-6">
                ...
                <input type="checkbox" name="chkFlexSearch2" id="chkFlexSearch2" value="true"  class="checkbox-inline" checked="checked"/>
                <label for="chkFlexSearch2">Flexible dates</label>
        ...
        <?php // start left col?>
            <div class="col-sm-6">
                ...
                <input type="text" name="txtDepCity3" class="txtDepCity cls_autofill form-control" value=""
                                    defvalue="Airport or City" onfocus="focusObj(this);" onblur="blurObj(this);"
                                    onchange="copyTextbox(this, document.getElementById('txtArrCity3'));" autocomplete="off"
                                    id="txtDepCity3" placeholder="From: Airport or City"/>
                </div>
            </div>
...
<?php // start right col?>
            ...
            <input type="text" name="txtArrCity3" class="txtDepCity cls_autofill form-control" value=""
                                    defvalue="Airport or City" onfocus="focusObj(this);" onblur="blurObj(this);"
                                    onchange="copyTextbox(this, document.getElementById('txtDepCity3'));" autocomplete="off"
                                    id="txtArrCity3" placeholder="To: Airport or City"/>
            </div>
...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <span>Children</span><div>(2-11)</div>
    ...
    <div class="col-sm-4">
<span>Infants</span><div>(Under 2)</div>
...
<?php // start row?>
    <div class="row search_age_row">
        <?php // start left col?>
            <div class="col-sm-12">
               <div class="travellers_label"><span>Adults</span><div>(12+)</div></div>  
              ...
              <div class="travellers_label"><span>Children</span><div>(2-11)</div></div>   
                <div class="travellers">
                 <select name="ddlPaxCHD" id="ddlPaxCHD">
                                    <option value="0">0</option>
                                    <option value="1">1</option>
                ...
                <div class="travellers_label"><span>Infants</span><div>(Under 2)</div></div>  
      <div class="travellers">
                <select name="ddlPaxINF" id="ddlPaxINF">
                                    <option value="0">0</option>
                                    <option value="1">1</option>
        ...
        <?php // start left col?>
            <div class="col-sm-12">
                <input type="checkbox" name="chkNonStop" id="chkNonStop" value="true" />
                            <label for="chkNonStop">Direct Flights</label>
            </div>
