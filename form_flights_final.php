...
<form name="frmAirSearch" method="post" action="https://res.perfectibe.com/process.aspx" enctype="multipart/form-data" onSubmit="return true;">
  ...
  <div id="flight_form_slector" class="row">
    ...
    <div class="col-sm-8">
      ...
      <div id="pnlFlight2" style="border: 1px red solid; background:pink; color:black;overflow:hidden">
          ...
          <table>
            ...
            <tr>
              <td><input type="text" name="txtDepCity2" class="txtDepCity cls_autofill" value="Airport or City" defValue="Airport or City" onFocus="focusObj(this);" onBlur="blurObj(this);" onChange="copyTextbox(this, document.getElementById('txtArrCity3'));" autocomplete="off" id="txtDepCity2" />
              </td>
              <td><input type="text" name="txtArrCity2" class="txtDepCity cls_autofill" value="Airport or City" defValue="Airport or City" onFocus="focusObj(this);" onBlur="blurObj(this);" onChange="copyTextbox(this, document.getElementById('txtDepCity3'));" autocomplete="off" id="txtArrCity2" />
              </td>
            </tr>
            <tr>
              <td><input name="chkDepCityRadius2" type="checkbox" id="chkDepCityRadius2" value="true">
                <label for="chkDepCityRadius2">80 miles radius search</label>
                &nbsp;</td>
              <td><input name="chkArrCityRadius2" type="checkbox" id="chkArrCityRadius2" value="true">
                <label for="chkArrCityRadius2">80 miles radius search</label>
                &nbsp;</td>
            </tr>
            <tr>
              <td><script type="text/javascript">DateInput('txtDate2', true, 'MM/DD/YYYY', formatDate(dateAdd('d',7,Today), 'MM/dd/yyyy'))</script>
              </td>
              <td><select name="ddlTime2" id="ddlTime2">
            ...
            <tr>
              <td colspan="2"><input type="checkbox" name="chkFlexSearch2" id="chkFlexSearch2" value="true">
                <label for="chkFlexSearch2">+/- 1 Day Search</label></td>
            </tr>
          </table>
      ...
      <div id="pnlFlight3" style="border: 1px red solid; background:yellow; color:black;overflow:hidden">

<table>
            <tr>
              <td colspan="2" bgcolor="GainsBoro"><span class="label">Flight 3</span></td>
            </tr>
            <tr>
              <td>From</td>
              <td>To</td>
            ...
            <tr>
              <td><input type="text" name="txtDepCity3" class="txtDepCity cls_autofill" autocomplete="off" id="txtDepCity3">
              </td>
              <td><input type="text" name="txtArrCity3" class="txtDepCity cls_autofill" autocomplete="off" id="txtArrCity3">
              </td>
            </tr>
            <tr>
              <td><input name="chkDepCityRadius3" type="checkbox" id="chkDepCityRadius3" value="true">
                <label for="chkDepCityRadius3">80 miles radius search</label>
                &nbsp;</td>
              <td><input name="chkArrCityRadius3" type="checkbox" id="chkArrCityRadius3" value="true">
                <label for="chkArrCityRadius3">80 miles radius search</label>
                &nbsp;</td>
            </tr>
            <tr>
              <td><script type="text/javascript">DateInput('txtDate3', true, 'MM/DD/YYYY', formatDate(dateAdd('d',14,Today), 'MM/dd/yyyy'))</script>
              </td>
              <td><select name="ddlTime3" id="ddlTime3">
                  <option value="Anytime">Anytime</option>
                  <option value="0100">1 am</option>
                  <option value="0200">2 am</option>
                  <option value="0300">3 am</option>
            ...
            <tr>
              <td colspan="2"><input type="checkbox" name="chkFlexSearch3" id="chkFlexSearch3" value="true">
                <label for="chkFlexSearch3">+/- 1 Day Search</label></td>
            </tr>
          </table>
        </div></td>
    </tr>
    <tr>
      <td bgColor="Gainsboro">Travellers</td>
    </tr>
    <tr>
      <td><table width="100%">
          <tr>
            <td><div align="center">Adults (12+)</div></td>
            <td><div align="center">Children (2-11)</div></td>
            <td><div align="center">Infants (Under 2)</div></td>
          </tr>
          <tr>
            <td><div align="center">
    ...
    <tr>
      <td bgColor="Gainsboro">Options</td>
    </tr>
    <tr>
      <td><table>
          <tr>
            <td class="style1"> Cabin</td>
            <td><select name="ddlCabin" id="ddlCabin">
          ...
          <tr>
            <td class="style1">Airline</td>
            <td><select name="ddlAirline" id="ddlAirline">
          ...
          <tr>
            <td class="style1">Coupon</td>
            <td>
                <input name="txtCoupon" type="text" autocomplete="off" id="txtCoupon" /></td>
          </tr>
          <tr>
            <td class="style1"><input type="checkbox" name="chkNonStop" id="chkNonStop" value="true"></td>
            <td><label for="chkNonStop">I prefer non-stop flights</label></td>
          </tr>
        </table></td>
    </tr>
    <tr>
